...
export const Route = createFileRoute("/derecho-penal")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.hilolegal.es/derecho-penal" },
      ...
      { name: "twitter:title", content: "Abogada Penalista en Altea | HiloLegal" },
      { name: "twitter:description", content: "Defensa técnica desde la primera declaración, con transparencia sobre las expectativas reales del caso." },
      { name: "twitter:image", content: "https://www.hilolegal.es/VERODERECHA.webp" },
    ],
    links: [{ rel: "canonical", href: "https://www.hilolegal.es/derecho-penal" }],
    scripts: [
      {
          ...
          "@graph": [
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 3, name: "Derecho penal", item: "https://www.hilolegal.es/derecho-penal" },
              ],
            },
            {
              "@type": "FAQPage",
  ...
  component: DerechoPenalPage,
});

const WHATSAPP = "https://wa.me/34647506040?text=Necesito%20asesoramiento%20en%20un%20procedimiento%20penal";
...
function DerechoPenalPage() {
  useEffect(() => {
    trackEvent("legal_area_view", { page: "derecho-penal" });
  }, []);
      ...
      <div className="mx-auto px-6">
        <div className="space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-[1.08] tracking-tight text-balance">
            <WordReveal eager block delay={0.1} text="La primera declaración" />
            <WordReveal eager block delay={0.325} className="text-[#C5A566]" text="marca todo lo que" />
            <WordReveal eager block delay={0.46} text="viene después." />
          </h1>
          <FadeUp delay={0.6}>
            <p className="hero-subtitle">
              Un procedimiento penal exige una defensa técnica sin fisuras y una estrategia clara desde el
              primer momento. Ofrezco asistencia letrada con transparencia sobre las expectativas reales del caso.
            </p>
          </FadeUp>
          <FadeUp delay={0.75}>
...
const pasos = [
  { n: "01.", title: "Analizamos el expediente", text: "Revisamos cada pieza de la acusación antes de definir cualquier línea de defensa." },
  { n: "02.", title: "Preparamos la primera declaración", text: "Lo que se dice en ese momento condiciona el resto del procedimiento — se prepara con antelación, no de memoria." },
  { n: "03.", title: "Anticipamos los movimientos de la acusación", text: "Una defensa sin fisuras se construye pensando varios pasos por delante, no reaccionando sobre la marcha." },
  { n: "04.", title: "Te acompañamos en cada fase", text: "Con transparencia sobre las expectativas reales, sin promesas que no se puedan cumplir." },
];
    ...
    <section id="como-trabajamos" className="py-[100px] bg-[var(--jch-surface)]">
      <div className="method-block__inner">
        <div className="method-block__intro">
          ...
          <FadeUp delay={0.1}><p>Defensa técnica sin fisuras, desde la primera declaración hasta el final del proceso.</p></FadeUp>
        </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div className="space-y-12">
          <h2 className="contact-editorial__title text-5xl md:text-6xl font-bold tracking-tight">
            <Curtain>Hablemos de <span className="text-[#C5A566]">tu caso</span></Curtain>
          </h2>
          <FadeUp delay={0.1}>
            <p className="contact-editorial__description text-xl leading-relaxed">
              Cuéntame la situación y te digo con claridad cómo puedo ayudarte, en la primera consulta.
            </p>
          </FadeUp>
