    ...
    handlers: {
      GET: async () => {
        ...
        const entries = [
          ...
          { path: "/derecho-familia", changefreq: "monthly", priority: "0.7", lastmod: "2026-09-15" },
          { path: "/derecho-penal", changefreq: "monthly", priority: "0.7", lastmod: "2026-09-15" },
          { path: "/derecho-administrativo", changefreq: "monthly", priority: "0.7", lastmod: "2026-09-21" },
          { path: "/derecho-inmobiliario", changefreq: "monthly", priority: "0.7", lastmod: "2026-09-15" },
          ...
          { path: "/blog", changefreq: "weekly", priority: "0.7", lastmod: "2026-09-21" },
          ...blogPosts.map((p) => ({
            path: `/blog/${p.slug}`,
