...
export const Route = createFileRoute("/administracion-fincas/nueva-comunidad")({
  head: () => ({
    meta: [
      { title: "Administración de Fincas para Nuevas Comunidades | HiloLegal" },
      {
        name: "description",
        content:
          "Comunidad de propietarios recién constituida en Altea o la Marina Baixa. Constitución, presupuestos y puesta en marcha desde la primera junta.",
      },
      { property: "og:title", content: "Administración de Fincas para Nuevas Comunidades | HiloLegal" },
      { property: "og:description", content: "Desde la primera junta: constitución, presupuestos y puesta en marcha." },
      { property: "og:url", content: "https://www.hilolegal.es/administracion-fincas/nueva-comunidad" },
          ...
          "@graph": [
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 3, name: "Nueva comunidad", item: "https://www.hilolegal.es/administracion-fincas/nueva-comunidad" },
              ],
            },
            {
              "@type": "FAQPage",
      ...
      >
        <nav className="mx-auto flex w-full max-w-[1200px] items-center justify-between px-6 py-5">
          <Link to="/" className="group flex items-center gap-3">
            ...
            <span className="text-base font-bold tracking-tight text-[#C5A566] md:text-lg">Administración de Fincas</span>
          </Link>
...
function Hero() {
  return (
    <section className="hero-bg-section">
      <img alt="Nueva comunidad de propietarios" className="hero-bg-image" src="/fotoalteadespachohorizontal.webp" width={1536} height={1024} loading="eager" decoding="async" fetchPriority="high" />
        ...
        <div className="space-y-10">
          <FadeUp>
            <div className="hero-eyebrow inline-flex items-center gap-3">
              ...
              NUEVAS COMUNIDADES EN ALTEA Y MARINA BAIXA
            </div>
          </FadeUp>
          <h1 className="text-4xl md:text-6xl font-extrabold leading-[1.08] tracking-tight text-balance">
            <WordReveal eager block delay={0.1} text="Empezar con buen pie." />
            <WordReveal eager block delay={0.325} className="text-[var(--jch-accent-ink)]" text="Desde la primera" />
            <WordReveal eager block delay={0.46} text="junta." />
          </h1>
          <FadeUp delay={0.6}>
            <p className="hero-subtitle">
              Comunidades de nueva construcción: constitución, primeros presupuestos y puesta en
              marcha con criterio desde el primer día, sin decisiones improvisadas.
            </p>
          </FadeUp>
          <FadeUp delay={0.75}>
            <div className="flex flex-wrap gap-6 pt-2">
              ...
              <a href="#primeros-pasos" className="btn-ghost">Ver primeros pasos</a>
            </div>
          </FadeUp>
        </div>
      </div>
...
const implica = [
  { n: "01", title: "Constitución formal", text: "La comunidad se constituye en junta, con estatutos si los hay, y queda formalmente reconocida ante terceros." },
  { n: "02", title: "Primer presupuesto", text: "Se prepara un presupuesto inicial realista, con las partidas propias de un edificio recién entregado." },
  { n: "03", title: "Criterio desde el inicio", text: "Las decisiones de los primeros meses marcan cómo funcionará la comunidad los próximos años. Conviene empezar bien." },
];

function QueImplica() {
  return (
    <section id="que-implica" className="content-block py-[100px] border-t border-[var(--jch-line)]">
      <div className="content-block__inner">
        <div className="content-block__heading">
          <h2><Curtain>Qué implica poner en marcha una comunidad nueva.</Curtain></h2>
          <FadeUp delay={0.1}><p>Las primeras decisiones importan más de lo que parece.</p></FadeUp>
        </div>
...
const pasos = [
  { n: "01.", title: "Junta constitutiva", text: "Se convoca y celebra la primera junta: aprobación de estatutos si procede, nombramiento de presidente." },
  { n: "02.", title: "Apertura de cuenta", text: "Se abre la cuenta bancaria de la comunidad, separada del promotor y de cualquier propietario individual." },
  { n: "03.", title: "Primer presupuesto y cuotas", text: "Se aprueba el presupuesto inicial y se calculan las cuotas según coeficientes de participación." },
  { n: "04.", title: "Puesta en marcha", text: "Contratación de proveedores esenciales (limpieza, mantenimiento, seguros) y calendario de las primeras juntas." },
];

function PrimerosPasos() {
  return (
    <section id="primeros-pasos" className="py-[100px] border-t border-[var(--jch-line)] bg-[var(--jch-surface)]">
      <div className="method-block__inner">
        <div className="method-block__intro">
          <h2><Curtain>Primeros pasos.</Curtain></h2>
          <FadeUp delay={0.1}><p>De la entrega de llaves a una comunidad en marcha.</p></FadeUp>
        </div>
...
const faqs = [
  { q: "¿Cuándo hay que contactar con un administrador si la promoción es nueva?", a: "Cuanto antes, idealmente antes de la primera junta constitutiva, para llegar con el proceso ya preparado y evitar decisiones improvisadas." },
  { q: "¿Qué hace falta para constituir la comunidad?", a: "Celebrar la junta constitutiva, aprobar los estatutos si los hay, nombrar presidente y aprobar un primer presupuesto. Se acompaña en cada uno de estos pasos." },
  { q: "¿Se puede empezar con pocos propietarios instalados?", a: "Sí. Es habitual constituir la comunidad con parte de las viviendas aún sin entregar. El presupuesto y las cuotas se ajustan según van entrando los propietarios." },
  { q: "¿Quién se encarga de contratar los primeros proveedores?", a: "Se prepara una propuesta de proveedores esenciales (limpieza, mantenimiento, seguros) para que la junta decida con varias opciones comparadas." },
];
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div className="space-y-12">
          <h2 className="contact-editorial__title text-5xl md:text-6xl font-bold tracking-tight">
            <Curtain>Preparemos <span className="text-[var(--jch-accent-ink)]">el arranque</span></Curtain>
          </h2>
          <FadeUp delay={0.1}>
            <p className="contact-editorial__description text-xl leading-relaxed">
              Cuéntame en qué fase está la promoción y te propongo cómo organizar los primeros meses.
            </p>
          </FadeUp>
  ...
  return (
    <form className="contact-form-card space-y-10" onSubmit={onSubmit}>
      ...
      <div className="space-y-2">
        ...
        <textarea
          rows={4}
          placeholder="Cuéntanos en qué fase está la promoción"
          value={form.message}
