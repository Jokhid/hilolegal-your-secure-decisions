  ...
  head: () => ({
    meta: [
      { title: "Administración de Fincas para Nuevas Comunidades | HiloLegal" },
      {
        name: "description",
        content:
          "Comunidad de propietarios recién constituida en Altea o la Marina Baixa. Constitución, primeros presupuestos y puesta en marcha con criterio desde la primera junta.",
      },
...
function Hero() {
  return (
    <section className="hero-bg-section">
      <img alt="Nueva comunidad de propietarios" className="hero-bg-image" src="/jc-service-fincas.webp" loading="eager" decoding="async" fetchPriority="high" />
