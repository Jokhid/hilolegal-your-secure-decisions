  ...
  head: () => ({
    meta: [
      { title: "Cambio de Administrador de Fincas en Altea | HiloLegal" },
      {
        name: "description",
        content:
          "¿Tu comunidad quiere cambiar de administrador de fincas? Te explicamos cómo hacerlo de forma ordenada, sin roturas ni interrupciones en el servicio, en Altea y la Marina Baixa.",
      },
      { property: "og:title", content: "Cambio de Administrador de Fincas | HiloLegal" },
      { property: "og:description", content: "Un cambio de administrador ordenado, sin roturas ni sorpresas." },
...
function Hero() {
  return (
    <section className="hero-bg-section">
      <img alt="Cambio de administrador de fincas" className="hero-bg-image" src="/fincas.webp" loading="eager" decoding="async" fetchPriority="high" />
        ...
        <div className="space-y-10">
          ...
          <FadeUp delay={0.6}>
            <p className="hero-subtitle">
              ...
              hacer de forma ordenada, sin roturas ni interrupciones en el servicio.
            </p>
          </FadeUp>
          <FadeUp delay={0.75}>
