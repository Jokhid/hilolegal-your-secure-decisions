...
const FONT_PRIMARY = "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&family=Poppins:wght@400;500;600;700&display=swap";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://hilolegal.es/" },
      { property: "og:image", content: "https://hilolegal.es/fotoalteadespacho.webp" },
      ...
      { name: "twitter:image", content: "https://hilolegal.es/fotoalteadespacho.webp" },
    ],
    links: [
