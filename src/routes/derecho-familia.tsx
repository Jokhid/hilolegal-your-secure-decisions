...
export const Route = createFileRoute("/derecho-familia")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.hilolegal.es/derecho-familia" },
      ...
      { name: "twitter:title", content: "Abogada de Familia y Herencias en Altea | HiloLegal" },
      { name: "twitter:description", content: "Herencias, divorcios y contratos con seguridad jurídica, analizados con honestidad sobre qué es realmente viable." },
      { name: "twitter:image", content: "https://www.hilolegal.es/VERODERECHA.webp" },
    ],
    links: [{ rel: "canonical", href: "https://www.hilolegal.es/derecho-familia" }],
    scripts: [
      {
          ...
          "@graph": [
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 3, name: "Derecho civil y de familia", item: "https://www.hilolegal.es/derecho-familia" },
              ],
            },
            {
              "@type": "FAQPage",
  ...
  component: DerechoFamiliaPage,
});

const WHATSAPP = "https://wa.me/34647506040?text=Quiero%20informaci%C3%B3n%20sobre%20una%20herencia%20o%20un%20divorcio";
...
function DerechoFamiliaPage() {
  useEffect(() => {
    trackEvent("legal_area_view", { page: "derecho-familia" });
  }, []);
      ...
      <div className="mx-auto px-6">
        <div className="space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-[1.08] tracking-tight text-balance">
            <WordReveal eager block delay={0.1} text="Una herencia o un divorcio" />
            <WordReveal eager block delay={0.325} className="text-[#C5A566]" text="no deberían decidirse" />
            <WordReveal eager block delay={0.46} text="a ciegas." />
          </h1>
          <FadeUp delay={0.6}>
            <p className="hero-subtitle">
              Son decisiones personales con una dimensión jurídica inevitable. Analizo tu caso con
              honestidad sobre qué es realmente viable, antes de que el conflicto se alargue durante años.
            </p>
          </FadeUp>
          <FadeUp delay={0.75}>
...
const pasos = [
  { n: "01.", title: "Analizamos los hechos", text: "Revisamos la documentación, los plazos y los antecedentes antes de decir nada sobre el caso." },
  { n: "02.", title: "Te decimos qué es viable", text: "Con honestidad sobre las opciones reales de éxito, no sobre lo que te gustaría oír." },
  { n: "03.", title: "Diseñamos la estrategia", text: "Una vez decides seguir adelante, planificamos los pasos con objetivos claros desde el principio." },
  { n: "04.", title: "Te representamos hasta el final", text: "Representación completa en el proceso, con información sobre cada paso antes de darlo." },
];
    ...
    <section id="como-trabajamos" className="py-[100px] bg-[var(--jch-surface)]">
      <div className="method-block__inner">
        <div className="method-block__intro">
          ...
          <FadeUp delay={0.1}><p>Rigor técnico y honestidad sobre las opciones reales, desde la primera consulta.</p></FadeUp>
        </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div className="space-y-12">
          <h2 className="contact-editorial__title text-5xl md:text-6xl font-bold tracking-tight">
            <Curtain>Hablemos de <span className="text-[#C5A566]">tu situación</span></Curtain>
          </h2>
          <FadeUp delay={0.1}>
            <p className="contact-editorial__description text-xl leading-relaxed">
              Cuéntame tu caso y te digo con claridad si puedo ayudarte y cómo, en la primera consulta.
            </p>
          </FadeUp>
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      await submit({
        data: {
          ...form,
          topic: "Derecho civil y de familia",
