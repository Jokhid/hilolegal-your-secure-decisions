(() => {
  ...
  const JOSE_CARLOS_BIO = "Administrador de fincas y gestor de Nationale Nederlanden, ING y Abanca. Especialista en planificación financiera, hipotecas, seguros, protección de autónomos, ahorro y previsión patrimonial.";
  const AREA_IMAGES = {
